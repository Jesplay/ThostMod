...
package net.mcreator.thostmod.world.inventory;
...
public class ThostBagGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ThostBagGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
